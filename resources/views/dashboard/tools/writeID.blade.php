@extends('dashboard.main', [
    'title' => 'Tools Menulis Ulang Artikel Indo'
])
@section('asset')
    ...
    async function paraphraseControler(string, lang) {
        ...
        async function showParaphrase(start, end, option) {
            for (let i = start; i < end; i++) {
                const api_url =
                    `https://translate.googleapis.com/translate_a/single?client=gtx&sl=${lang[i]}&tl=${lang[i + 1]}&dt=t&q=${paraphrase}`;
        ...
        <div class="col-md-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        <button onclick="clipboardHandler('paraphrase-output-1')" type="button" class="btn btn-sm btn-warning">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    class="form-control paraphrase-output" rows="3"></textarea>
                    <div class="d-flex justify-content-between">
                        <button onclick="clipboardHandler('paraphrase-output-2')" type="button" class="btn btn-sm btn-warning">
                            <i class="fa fa-clipboard" aria-hidden="true"></i>
                        </button>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    class="form-control paraphrase-output" rows="3"></textarea>
                    <div class="d-flex justify-content-between">
                        <button onclick="clipboardHandler('paraphrase-output-3')" type="button" class="btn btn-sm btn-warning">
                            <i class="fa fa-clipboard" aria-hidden="true"></i>
                        </button>
